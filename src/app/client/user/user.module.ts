...
@NgModule({
  declarations: [UserComponent, CartComponent, OrderMakingComponent, UserOrdersComponent, UserOrderDataComponent, OrderFeedbackComponent, AddressesManageComponent, NotificationPageComponent],
    imports: [
        CommonModule,
        UserRoutingModule,
        FormsModule,
